...
Showdown directly using WebSocket:
    ...
    ws://sim.psim.online:8000/showdown/websocket
      or
    wss://sim.psim.online/showdown/websocket
...
> characters. (Also feel free to make the request to `https://main.pokemon-world.online/` if your client
> supports it.)
>
