	...
	var BattleRoom = this.BattleRoom = ConsoleRoom.extend({
		...
		updateControls: function (force) {
			...
			if (this.battle.ended) {
				...
				var replayDownloadButton = '<span style="float:right;"><a href="//replay.pokemon-world.online/" class="button replayDownloadButton" style="padding:2px 6px"><i class="fa fa-download"></i> Download replay</a><br /><br /><button name="saveReplay"><i class="fa fa-upload"></i> Upload and share replay</button></span>';
